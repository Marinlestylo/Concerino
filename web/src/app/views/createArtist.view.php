                ...
                <div class="mb-6 md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-blue-100 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-800"
                               type="text" id="Sname" name="Sname" required autocomplete="off" placeholder="Eminem">
                    </div>
                </div>
                <div class="mb-6 md:flex md:items-center">
                    <div class="md:w-1/3">
                ...
                <div class="mb-6 md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-800"
                               type="text" id="lName" name="lName" required autocomplete="off" placeholder="Mathers ">
                    </div>
                </div>
                <div class="justify-center mb-6 md:flex md:items-center">
                    <fieldset>
                        <legend class="pr-4 mb-1 font-bold text-center text-indigo-100 w-fullblock md:text-right md:mb-0">
                            Quels sont les styles de l'artiste ?
                        </legend>
                ...
                <div class="mb-6 md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        ...
                        focus:border-blue-800 datepicker"
                               type="text" id="date" autocomplete="off" placeholder="dd.mm.yyyy">
