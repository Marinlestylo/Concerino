...
<?php if (isset($_SESSION['id'])) : ?>
    ...
    <div class="block pr-4 text-sm text-center text-indigo-500">Vous devez avoir assisté à ce concert afin de pouvoir le noter.</div>
<?php endif; ?>
...
<h1 class="mt-6 text-xl text-center text-blue-800 hover:underline"><a href="/user?id=<?= $data['concert'][0]->idcréateur ?>">Cliquez
