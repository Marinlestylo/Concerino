...
<h1 class="mt-24 text-5xl text-center text-blue-400">Créer un compte</h1>
    ...
    <div class="px-20 py-8 bg-blue-700 rounded-lg card md:pr-16 md:pl-2">
        <form class="add-meal" method="POST" action="/users" autocomplete="off">
            ...
            <div class="mb-6 md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-blue-100 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-800" type="text" id="fname" name="fname" required autocomplete="off" placeholder="John">
                </div>
            </div>
            <div class="mb-6 md:flex md:items-center">
                <div class="md:w-1/3">
                ...
                <div class="md:w-2/3">
                    <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-800" type="text" id="name" name="name" required autocomplete="off" placeholder="Doe">
                </div>
            </div>
            <div class="mb-6 md:flex md:items-center">
                <div class="md:w-1/3">
