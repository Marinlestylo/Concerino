    ...
    <div class="w-full max-w-lg mx-auto mt-16">
        <div class="px-20 py-8 bg-blue-700 rounded-lg card md:pr-16 md:pl-2">
            <form method="POST" action="/createGroup" autocomplete="off">
                <div class="mb-6 md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        <input class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-blue-100 rounded appearance-none focus:outline-none focus:bg-white focus:border-blue-800"
                               type="text" id="Sname" name="Sname" required autocomplete="off"
                               placeholder="Linkin Park">
                    </div>
                </div>
                <div class="px-4 mb-6 md:flex md:items-center">
                    <fieldset>
                        <legend class="pr-4 mb-1 font-bold text-left text-indigo-100 w-fullblock md:text-right md:mb-0">
                            Quels sont les styles du groupe ?
                        </legend>
                        <?php foreach ($data['styles'] as $style) : ?>
                            <div class="block pr-4 mb-1 font-bold text-indigo-100">
                                <input type="checkbox" id="<?= $style->nom ?>" name="styles[]"
                                       value="<?= $style->nom ?>">
                ...
                <div class="px-4 mb-6 md:flex md:items-center">
                    <fieldset>
                        <legend class="pb-4 pr-4 mb-1 font-bold text-indigo-100 w-fullblock md:mb-0">Indiquez les
                            membres du groupe et leur date d'entrée
                        </legend>
                        <?php foreach ($data['artists'] as $artist) : ?>
                            <div class="block pr-4 mb-1 font-bold text-indigo-100">
                                <input type="checkbox" id="<?= $artist->nomscène ?>" name="members[]"
                                       value="<?= $artist->id ?>">
                            ...
                            focus:border-blue-800 datepicker" type="text" autocomplete="off" name="dates[]"
